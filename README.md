...
Repository này là nơi lưu trữ chuỗi dự án phân tích dữ liệu và thiết kế báo cáo của tác giả. Bên cạnh báo cáo Logistics & Sales, bạn có thể tham khảo thêm các sản phẩm khác:

1.  **Amazon Sales Dashboard** ([Amazon_Sales_Dashboard.pbix](file:///C:/BI%20tool/Power%20BI/C%C3%A1c%20DashBoard%20%C4%91%C3%A3%20ho%C3%A0n%20thi%E1%BB%87n/Amazon_Sales_Dashboard.pbix) / [Amazon_Sales_Dashboard.pdf](file:///C:/BI%20tool/Power%20BI/C%C3%A1c%20DashBoard%20%C4%91%C3%A3%20ho%C3%A0n%20thi%E1%BB%87n/Amazon_Sales_Dashboard.pdf)): Phân tích hiệu quả kinh doanh trên sàn thương mại điện tử Amazon.
2.  **Sales Mobile & Computer Dashboards** ([DashBoard_sales_mobile.pbix](file:///C:/BI%20tool/Power%20BI/C%C3%A1c%20DashBoard%20%C4%91%C3%A3%20ho%C3%A0n%20thi%E1%BB%87n/DashBoard_sales_mobile.pbix) / [DashBoard_sales_Computer.pbix](file:///C:/BI%20tool/Power%20BI/C%C3%A1c%20DashBoard%20%C4%91%C3%A3%20ho%C3%A0n%20thi%E1%BB%87n/DashBoard_sales_Computer.pbix)): Báo cáo phân tích doanh thu chuyên biệt cho ngành hàng điện thoại di động và máy tính.
3.  **Delivery Dashboard 2** ([Delivery_DashBoard_2.pbix](file:///C:/BI%20tool/Power%20BI/C%C3%A1c%20DashBoard%20%C4%91%C3%A3%20ho%C3%A0n%20thi%E1%BB%87n/Delivery_DashBoard_2.pbix)): Trực quan hóa nâng cao về quy trình giao nhận và vận chuyển.
4.  **Project Data Analyst E-conomus** ([Project data analyst e conomus.pbix](file:///C:/BI%20tool/Power%20BI/C%C3%A1c%20DashBoard%20%C4%91%C3%A3%20ho%C3%A0n%20thi%E1%BB%87n/Project%20data%20analyst%20e%20conomus.pbix)): Dự án phân tích dữ liệu tài chính - kinh tế quy mô lớn.
...
2.  Clone repository này về máy cá nhân:
    ...
    ```
3.  Di chuyển đến thư mục dự án và mở file [Logistics_&_Sales_Dashboard.pbix](file:///C:/BI%20tool/Power%20BI/C%C3%A1c%20DashBoard%20%C4%91%C3%A3%20ho%C3%A0n%20thi%E1%BB%87n/Logistics_&_Sales_Dashboard.pbix).
